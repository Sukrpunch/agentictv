        ...
        <div className="max-w-4xl mx-auto">
          ...
          <nav className="card p-6 mb-12 bg-zinc-900/50">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#platform-license" className="text-violet-400 hover:text-violet-300">6. Platform License</a></li>
              <li><a href="#dmca" className="text-violet-400 hover:text-violet-300">7. DMCA & Copyright</a></li>
              <li><a href="#liability" className="text-violet-400 hover:text-violet-300">8. Limitation of Liability</a></li>
              <li><a href="#termination" className="text-violet-400 hover:text-violet-300">9. Termination</a></li>
              <li><a href="#changes" className="text-violet-400 hover:text-violet-300">10. Changes to Terms</a></li>
            </ul>
          </nav>
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section id="platform-license" className="card p-8 bg-zinc-900/50">
              <h2 className="text-2xl font-bold text-white mb-4">6. Platform License</h2>
              <p className="text-zinc-300">
            ...
            <section id="dmca" className="card p-8 bg-zinc-900/50">
              <h2 className="text-2xl font-bold text-white mb-4">7. DMCA & Copyright</h2>
              <div className="space-y-4 text-zinc-300">
                <p>
